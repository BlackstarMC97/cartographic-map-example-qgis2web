...
<head>
	<title>Home - Cartographic map for the municipality of Ngaoundere, ACAGER</title>
...
<body>
    <nav class="navbar navbar-light text-light navbar-special">
        <div class="container-fluid">
            ...
            <h2 class="text-dark mx-auto">Cartographic map for the municipality of Ngaoundere</h2>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-3 col-md-3 col-12 mb-4">
            <div class="mb-3 ml-3">
                ...
                <br>
                <a href="<?php echo $url; ?>/fr/?type=<?php echo $_GET['type']; ?>" class="link-special">
                    <img src="https://cdn.countryflags.com/thumbs/france/flag-round-250.png" style="height: 18px; padding-bottom: 3px;"> See the french version
                </a>
            </div>
        ...
        <div class="col-lg-9 col-md-9 col-12">
            <?php 
                ...
                if(isset($_GET["type"])) {
                    ...
                    echo 'Please choose one of the themes on the left...';
    ...
    <script type="text/javascript">
        ...
        function goToPage(page) {
            window.location.href = url + "/en/" + "?type=" + page;
        }
