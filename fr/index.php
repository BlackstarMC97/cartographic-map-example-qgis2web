...
<body>
    <nav class="navbar navbar-light text-light navbar-special">
        <div class="container-fluid">
            ...
            <h2 class="text-dark mx-auto">Guichet cartographique de la commune de Ngaoundéré</h2>
        </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-3 col-md-3 col-12 mb-4">
            <div class="mb-3 ml-3">
                ...
                <br>
                <a href="<?php echo $url; ?>/en/?type=<?php echo $_GET['type']; ?>" class="link-special">
                    <img src="https://cdn.countryflags.com/thumbs/united-kingdom/flag-round-250.png" style="height: 18px; padding-bottom: 3px;"> Voir la version anglaise
                </a>
            </div>
                ...
                <div class="collapse ssxhw" id="buildingCollapse">
                    <ul class="list-group border">
                        ...
                        <li id="inundation" class="list-group-item minus text-left clickable" onclick="goToPage(this.id);">
                            ...
                            Bâtiments exposés aux risques d'inondation
                        </li>
    ...
    <script type="text/javascript">
        ...
        function goToPage(page) {
            window.location.href = url + "/fr/" + "?type=" + page;
        }
